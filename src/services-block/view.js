...
function initializeStories() {
  ...
  if (blockElement) {
    ...
    if (dataSlides) {
      try {
        ...
        console.log('Got slides data from data-slides attribute:', slidesData.length, 'slides');
  ...
  if (slidesData.length === 0 && window.servicesBlockData) {
    console.log('Falling back to window.servicesBlockData');
    ...
    if (blockData && blockData.slides && blockData.slides.length > 0) {
      ...
      console.log('Got slides data from window.servicesBlockData:', slidesData.length, 'slides');
    }
  }
  ...
  if (slidesData && slidesData.length > 0) {
    ...
    console.log('Converted slides to stories format:', stories.length, 'stories');
  } else {

...
<rect width="24" height="24" fill="white"/>
	...
	'pricing-comparison-block' => array(
		'$schema' => 'https://schemas.wp.org/trunk/block.json',
		'apiVersion' => 3,
		...
		'attributes' => array(
			...
			'buttonOutlineColor' => array(
				'type' => 'string',
				'default' => '#111111'
			),
			'stickyBackground' => array(
				'type' => 'string',
				'default' => '#ffffff'
			),
			'stickyBorderColor' => array(
				'type' => 'string',
				'default' => '#e5e7eb'
			),
			'stickyLabel' => array(
...
<rect width="24" height="24" fill="white"/>
		...
		'attributes' => array(
			...
			'showComparisonTable' => array(
				'type' => 'boolean',
				'default' => true
			),
			'comparisonDisclaimer' => array(
				'type' => 'string',
				'default' => 'The above prices do not include applicable taxes based on your billing address. Unless otherwise specified, prices are in USD. The final price will be displayed on the checkout page. All subscriptions renew based on your billing cycle at list price. Prices are rounded for display. Your final price at checkout may be slightly lower. 30-day money-back guarantee applies only for annual plans.'
			),
			'comparisonToggleLabel' => array(
				'type' => 'string',

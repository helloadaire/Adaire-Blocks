...
document.addEventListener("DOMContentLoaded", function () {
  document.querySelectorAll('.cgwego-html').forEach(blockRoot => {
    ...
    function handleItemChange(index) {
      ...
      const elementsToAnimate = blockRoot.querySelectorAll(".title .cgwego-h1, .info .cgwego-p .line span, .info .cgwego-p, .credits .cgwego-p, .director .cgwego-p");
        ...
        if (currentProjectImgElem && currentProjectImg) {
          ...
          gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(currentProjectImg, {
            ...
            onComplete: () => {
              ...
              const newElementsToAnimate = newProjectDetails.querySelectorAll(".title .cgwego-h1, .info .cgwego-p .line span, .info .cgwego-p, .credits .cgwego-p, .director .cgwego-p");

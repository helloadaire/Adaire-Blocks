...
add_action('admin_post_my_plugin_rollback', function () {
    ...
    $previous_version_zip = 'https://github.com/helloadaire/Adaire-Blocks/releases/download/v1.1.4.alpha/adaire-blocks.1.1.4.premium.zip';
...
define('ADAIRE_BLOCKS_VERSION', '1.1.5');
